...
public class LogController {
    ...
    public ResponseEntity<List<LogEntry>> getLogEntries(HttpServletRequest request, HttpServletResponse response) {
        ...
        mockLogEntry = new LogEntry("N66SEX", "Mooney", "M20G", "690012", 477.7f, 77.7f, "This is the log entry", "WO485", new Date());
        logEntries.add(mockLogEntry);
        mockLogEntry = new LogEntry("NXXXXX", "Mooney", "M20G", "690011", 54747.7f, 4747.7f, "This is the log entry", "WO485", new Date());
        logEntries.add(mockLogEntry);
